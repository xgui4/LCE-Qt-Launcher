...
class SettingDialog(QDialog):
    ...
    def __init__(self, parent : QWidget, ui_setting : Ui_settingDialog, appContext : AppContext) -> None:
        ...
        self.ui_setting.accesibilitycheckBox.setChecked(bool(self.userPref.get_accesible_mode()))
        self.ui_setting.developperModeDheckBox.setChecked(bool(self.userPref.get_developper_mode()))
        self.ui_setting.holydayDheckBox.setChecked(bool(self.userPref.get_show_holiday()))
        self.ui_setting.enableExperimentscheckBox.setChecked(bool(self.userPref.get_experimental_mode()))
    ...
    def applyButtonCommand(self):
        ...
        self.userPref.set_theme_pref(str(theme.from_entity_to_strTheme(theme.ThemeEntity(themeSelectedIndex))))
